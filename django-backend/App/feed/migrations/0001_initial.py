    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('song', models.JSONField(blank=True)),
                ...
                ('is_premium', models.BooleanField(verbose_name=False)),
                ...
                ('Picture', models.FileField(null=True, upload_to='Images_uploaded', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['MOV', 'avi', 'mp4', 'webm', 'mkv'])])),
